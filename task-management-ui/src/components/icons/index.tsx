...
export const PaperClipIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m15.75 17.25 3.375-3.375a5.25 5.25 0 0 0 0-7.425l-.375-.375a5.25 5.25 0 0 0-7.425 0l-6.905 6.905a3.75 3.75 0 1 0 5.304 5.304l6.905-6.905a1.875 1.875 0 0 0 0-2.652l-.375-.375a1.875 1.875 0 0 0-2.652 0l-5.25 5.25" />
  </svg>
);
